...
class Todo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Todo', createEmptyInstance: create)
    ...
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'expiredAt', protoName: 'expiredAt')
  ...
  @$pb.TagNumber(7)
  $core.String get expiredAt => $_getSZ(6);
  @$pb.TagNumber(7)
  set expiredAt($core.String v) { $_setString(6, v); }
  @$pb.TagNumber(7)
