...
const Todo$json = const {
  ...
  '2': const [
    ...
    const {'1': 'expiredAt', '3': 7, '4': 1, '5': 9, '10': 'expiredAt'},
  ],
};

/// Descriptor for `Todo`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List todoDescriptor = $convert.base64Decode('CgRUb2RvEg4KAmlkGAEgASgJUgJpZBIUCgV0aXRsZRgCIAEoCVIFdGl0bGUSIAoLZGVzY3JpcHRpb24YAyABKAlSC2Rlc2NyaXB0aW9uEhQKBWltYWdlGAQgASgJUgVpbWFnZRIWCgZzdGF0dXMYBSABKAlSBnN0YXR1cxIcCgljcmVhdGVkQXQYBiABKAlSCWNyZWF0ZWRBdBIcCglleHBpcmVkQXQYByABKAlSCWV4cGlyZWRBdA==');
